...
(function( $ ){
	...
	asyncTest( "panel should call getWrapper only once on create", function(){
		expect( 5 );
	...
	asyncTest( "external pane should call panel once on create and on page changes", function(){
		expect( 5 );
